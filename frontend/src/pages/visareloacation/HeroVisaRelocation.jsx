          ...
          <div className="space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center space-x-2 text-primary mb-4">
              ...
              <span className="text-sm font-medium tracking-wider uppercase">
                Visa and Relocation Guidelines
              </span>
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
              <span className="text-primary mr-2">Visa and Relocation</span>
              Guidelines
            </h1>

            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto lg:mx-0">
              Your Guide to a Smooth Transition to Europe
            </p>
          </div>
...
export default HeroVisaRelocation;

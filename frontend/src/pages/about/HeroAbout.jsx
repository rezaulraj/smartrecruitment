        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto lg:mx-0">
              We connect skilled workers from Nepal, Bangladesh, India, and the
              Philippines with opportunities in Europe, driving growth for
              individuals and businesses alike through ethical recruitment.
            </p>

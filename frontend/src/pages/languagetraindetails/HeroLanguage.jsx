...
import language from "../../assets/image/skilltrain/language.png?url";
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-2xl text-center mx-auto">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">
            Speak Easy in Europe:
            <span className="text-primary ml-2">English Mastery</span> for
            Workers Abroad
          </h1>

          <p className="text-lg sm:text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Practical English Skills for Workplace and Daily Life: Master Speaking, Vocabulary, and Cultural Integration [Beginner to Intermediate]
          </p>

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
              Join <span className="text-primary mr-2"> Our Missions</span>
              to Transform Lives
            </h1>

            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto lg:mx-0">
              At Smart Recruit, we connect skilled workers from Nepal,
              Bangladesh, and India to rewarding careers in Europe, empowering
              over 10,000 lives since 2020. Be part of a team that builds
              bridges and creates brighter futures.
            </p>
